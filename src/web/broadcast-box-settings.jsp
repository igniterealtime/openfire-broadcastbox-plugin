...
<%@ page import="org.ifsoft.broadcastbox.openfire.*" %>
...
<%
    ...
    {    
        ...
        JiveGlobals.setProperty("broadcastbox.port", port);   
		
        String portRangeMin = request.getParameter("port_udp");     
        JiveGlobals.setProperty("broadcastbox.port.udp", portRangeMin); 		
        
        String ipaddr = request.getParameter("ipaddr");     
        JiveGlobals.setProperty("broadcastbox.ipaddr", ipaddr);      

        String ipaddrPublic = request.getParameter("ipaddr_public");     
        JiveGlobals.setProperty("broadcastbox.ipaddr.public", ipaddrPublic); 		
        
        String url = request.getParameter("url");     
        JiveGlobals.setProperty("broadcastbox.url", url);         
        
        String enabled = request.getParameter("enabled");
        JiveGlobals.setProperty("broadcastbox.enabled", (enabled != null && enabled.equals("on")) ? "true": "false");  		
    }
...
<head>
   ...
   <meta name="pageID" content="broadcastbox-settings"/>
</head>
<body>
...
<form action="broadcast-box-settings.jsp" method="post">
    <p>
        <table class="jive-table" cellpadding="0" cellspacing="0" border="0" width="100%">
            ...
            <tr>
                <td nowrap  colspan="2">
                    <input type="checkbox" name="enabled"<%= (JiveGlobals.getProperty("broadcastbox.enabled", "true").equals("true")) ? " checked" : "" %>>
            ...
            <tr>
                ...
                <td><input type="text" size="50" maxlength="100" name="ipaddr" required
                       value="<%= JiveGlobals.getProperty("broadcastbox.ipaddr", plugin.getIpAddress()) %>">
                </td>                               
            </tr>			
            <tr>
                <td align="left" width="150">
                ...
                <td><input type="text" size="50" maxlength="100" name="ipaddr_public" required
                       value="<%= JiveGlobals.getProperty("broadcastbox.ipaddr.public", plugin.getPublicIpAddress()) %>">
                </td>                               
            </tr>                   
            <tr>
                <td align="left" width="150">
                ...
                <td><input type="text" size="50" maxlength="100" name="port" required
                       value="<%= JiveGlobals.getProperty("broadcastbox.port", plugin.getPort()) %>">
                </td>                               
            </tr>  
            <tr>
                <td align="left" width="150">
                ...
                <td><input type="text" size="50" maxlength="100" name="port_udp" required
                       value="<%= JiveGlobals.getProperty("broadcastbox.port.udp", plugin.getUDPPort()) %>">
                </td>                               
            </tr>  	           
            <tr>
                <td align="left" width="150">
                ...
                <td><input type="text" size="50" maxlength="100" name="url" required
                       value="<%= JiveGlobals.getProperty("broadcastbox.url", service_url) %>">
                </td>                               
            </tr>            
            </tbody>
        </table>
